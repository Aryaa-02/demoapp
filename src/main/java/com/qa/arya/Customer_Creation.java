...
public class Customer_Creation {
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.id("account_email")).sendKeys("ginniarya56@gmail.com");
        ...
        wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//span[contains(@class, 'Polaris-Text--bodySm') and text()='Add customer']"))).click();
